...
extension FilesDatabaseManager {
    ...
    public func deleteDirectoryAndSubdirectoriesMetadata(
        ...
        do {
            ...
            logger.error("Failure to delete root directory metadata in recursive delete: \(error.localizedDescription)", [.eTag: directoryEtag, .ocId: directoryOcId, .url: directoryUrlPath])
            return nil
        }
        ...
        for result in results {
            ...
            do {
                ...
                logger.error("Failure to delete directory metadata child in recursive delete: \(error.localizedDescription)", [.eTag: directoryEtag, .ocId: directoryOcId, .url: directoryUrlPath])
            }
        }
